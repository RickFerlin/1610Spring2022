...
public class PlayerControllerX : MonoBehaviour
{
    ...
    private float boostSpeed = 35; //Added to regulate boost speed
    ...
    public ParticleSystem boosterParticle; //variable for booster object
    ...
    void Update()
    {
        ...
        //Uses boost and plays particle effect. Coroutine keeps player from spamming boost.
